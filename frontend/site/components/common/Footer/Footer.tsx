      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 border-b border-accent-2 py-12 text-primary bg-primary transition-colors duration-150">
          <div className="col-span-1 lg:col-span-2">
            ...
            >
              ...
              <span className="hover:bg-accent-2 px-2 rounded-md">
          ...
          <div className="col-span-1 lg:col-span-3 flex items-start lg:justify-end text-primary">
            <div className="flex space-x-4 items-center h-10">
              ...
              <a
                ...
                href="https://github.com/YagoLopez/vendure-nextjs-ecommerce"
              >
                <Github />
              </a>
            </div>
        ...
        <div className="pt-6 pb-10 flex flex-col md:flex-row justify-between items-center space-y-4 text-accent-6 text-sm">
          <div className="flex items-center text-primary text-sm">
            <span className="text-primary text-center">Developed under Open Source License (2023)</span>
          </div>
        </div>
      </Container>
    </footer>
